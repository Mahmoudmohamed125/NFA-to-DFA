...
background_music = 'Untitled video - Made with Clipchamp.mp3'  # Path to background music
...
while exit:
    ...
    draw_text_with_stroke("Samer ELhossany 221001697",font_object,(70,name1y))
    draw_text_with_stroke("Mahmoud Abdelglil 221001313",font_object,(70,name2y))
    draw_text_with_stroke("Abdelrahman Rahal 221001443",font_object,(70,name3y))
    draw_text_with_stroke("Nour Elsharkawy 221001458",font_object,(70,name4y))              
    ...
    if logoy<100:
      decrement=0
      draw_text_with_stroke("Press any key to continue",font_object,(70,500))
    clock.tick(FPS)
